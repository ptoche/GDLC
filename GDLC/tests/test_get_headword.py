...
>>> dml = '''<p class="df"><code class="calibre22"><sup class="calibre23">■</sup><strong class="calibre13">ABC -xy</strong></code><sup class="calibre23">1</sup></p>'''
...
>>> from GDLC.GDLC import *
>>> dml = '<p class="df"><strong class="calibre13"><sup class="calibre23">3</sup>H</strong><sup class="calibre23">2</sup></p>'
>>> soup = BeautifulSoup(dml, features = 'lxml')
>>> tag = soup.find('p', attrs={'class':'df'})
